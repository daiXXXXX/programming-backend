...
-- 插入题目标签
INSERT IGNORE INTO problem_tags (problem_id, tag) VALUES
(1, '数组'), (1, '哈希表'),
(2, '字符串'), (2, '双指针'),
(3, '字符串'), (3, '双指针'),
(4, '数组'), (4, '动态规划'),
...
(2, 'a', 'a', 0, 2),
-- 有效的回文串
(3, 'A man, a plan, a canal: Panama', 'true', 1, 0),
(3, 'race a car', 'false', 1, 1),
(3, 'a', 'true', 0, 2),
-- 最大子数组
(4, '-2 1 -3 4 -1 2 1 -5 4', '6', 1, 0),
(4, '1', '1', 1, 1),
(4, '5 4 -1 7 8', '23', 0, 2),
-- 合并两个有序数组
(5, '1 3 5\n2 4 6', '1 2 3 4 5 6', 1, 0),
(5, '1\n2', '1 2', 1, 1),
(5, '1 2 3\n4 5 6', '1 2 3 4 5 6', 0, 2),
-- 二分查找
(6, '1 2 3 4 5\n3', '2', 1, 0),
(6, '1 2 3 4 5\n6', '-1', 1, 1),
(6, '1\n1', '0', 0, 2);
